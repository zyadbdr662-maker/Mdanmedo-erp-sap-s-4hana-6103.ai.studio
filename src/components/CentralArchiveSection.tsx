            ...
            <div className="space-y-6 text-xs text-slate-300 leading-relaxed font-sans">
              ...
              <div className="p-4 rounded-2xl bg-gradient-to-r from-slate-900 to-[#071829] border border-sap-secondary/40 space-y-3">
                ...
                <p className="text-[11px] text-slate-300 leading-relaxed">
                  نقر نحن الفريق البرمجي في منصة الذكاء الاصطناعي بأن هذا النظام بكامل مكوناته الـ 20 المحاسبية، وتصاميم الفواتير، ونظام شجرة الحسابات، ودليل الاستخدام الشامل، قد تم بناؤه وتجهيزه وتشغيله بنجاح، وهو ملك كامل ومستقل للمدير <strong>بدر عايض محمد</strong>.
                </p>
